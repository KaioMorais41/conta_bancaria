...
export function main() {
    ...
    const contacorrente: ContaCorrente = new ContaCorrente(1, 123, 1, "Adriana", 15000, 1000);
    ...
    const contapoupanca: ContaPoupanca = new ContaPoupanca(1, 123, 1, "Adriana", 10000, 10);
